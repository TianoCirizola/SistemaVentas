...
namespace SistemaVenta.AplicacionWeb.Controllers {
    ...
    public class VentaController : Controller {
        ...
        public async Task<IActionResult> ListaTipoDocumentoVenta() {
            List<TipoDocumentoVenta> lista = await _tipoDocumentoVentaService.Lista();
            List<VMTipoDocumentoVenta> vmListaTipoDocumentos = _mapper.Map<List<VMTipoDocumentoVenta>>(lista);
        ...
        public async Task<IActionResult> ObtenerProductos(string busqueda) {
            List<Producto> lista = await _ventaService.ObtenerProductos(busqueda);
        ...
        public async Task<IActionResult> Historial(string numeroVenta, string fechaInicio, string fechaFin) {
            List<Venta> lista = await _ventaService.Historial(numeroVenta, fechaInicio, fechaFin);
