...
$(document).on("click", "button.btn-eliminar", function () {
    ...
    productosParaVenta = productosParaVenta.filter(p => p.idProducto != idProducto);
...
$("#btnTerminarVenta").click(function () {
    if (productosParaVenta.length < 1) {
        toastr.warning("", "Debe agregar productos");
        return;
    }
    ...
    fetch("/Venta/RegistrarVenta", {
        ...
        .then(responseJson => {
            if (responseJson.estado) {
                ...
                $("#cboTipoDocumentoVenta").val($("#cboTipoDocumentoVenta options:first").val());
