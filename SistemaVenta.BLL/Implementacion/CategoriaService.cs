    ...
    public class CategoriaService : ICategoriaService {
        ...
        public async Task<Categoria> Crear(Categoria entidad) {
            try {
                ...
                if (categoriaCreada.IdCategoria == 0) throw new TaskCanceledException("No se pudo crear la categoría");
        ...
        public async Task<Categoria> Editar(Categoria entidad) {
            try {
                ...
                if (!respuesta) throw new TaskCanceledException("No se pudo modificar la categoría");
        ...
        public async Task<bool> Eliminar(int idCategoria) {
            try {
                ...
                if (categoriaEncontrada == null) throw new TaskCanceledException("La categoría no existe");
