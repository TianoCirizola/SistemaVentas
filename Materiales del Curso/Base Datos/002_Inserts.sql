...
--________________________________ INSERTAR PRODUCTOS ________________________________

INSERT INTO Producto (codigoBarra, marca, descripcion, idCategoria, stock, urlImagen, nombreImagen, precio, esActivo, fechaRegistro)
VALUES ('101011', 'Lenovo', 'Laptop Core i7', 1, 10, NULL, NULL, 2499.00, 1, '2025-02-08 19:30:00.000');

INSERT INTO Producto (codigoBarra, marca, descripcion, idCategoria, stock, urlImagen, nombreImagen, precio, esActivo, fechaRegistro)
VALUES ('101012', 'Logitech', 'Mouse Inalámbrico', 2, 50, NULL, NULL, 199.00, 1, '2025-02-08 19:35:00.000');

INSERT INTO Producto (codigoBarra, marca, descripcion, idCategoria, stock, urlImagen, nombreImagen, precio, esActivo, fechaRegistro)
VALUES ('101013', 'Samsung', 'Monitor 24 Pulgadas', 1, 8, NULL, NULL, 999.00, 1, '2025-02-08 19:40:00.000');

INSERT INTO Producto (codigoBarra, marca, descripcion, idCategoria, stock, urlImagen, nombreImagen, precio, esActivo, fechaRegistro)
VALUES ('101014', 'Kingston', 'Memoria RAM 8GB', 3, 20, NULL, NULL, 349.00, 1, '2025-02-08 19:45:00.000');